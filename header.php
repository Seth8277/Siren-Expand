...
<head>
    ...
    <div class="old-browser">
        <a href="http://browsehappy.com/">
            <img src="<?php bloginfo('template_url'); ?>/images/older-browsers.png"
                 alt="您的浏览器版本过低，为了保障您的访问安全，以及获得更友好的用户体验，建议您升级您的浏览器到最新版本。">
        </a>
    </div>
    <![endif]-->
            ...
            <div class="site-top">
                <div class="site-branding">
                    <?php if (akina_option('akina_logo')){ ?>
                        <div class="site-title"><a href="<?php bloginfo('url'); ?>"><img class="tiaodan"
                                                                                         OnMouseOver="rbq()"
